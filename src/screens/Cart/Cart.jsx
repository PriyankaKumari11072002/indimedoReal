              ...
              <div>
                <dl className=" space-y-1 px-2 py-4">
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    ₹ {cart?.data?.cartTotal-cart?.data?.totalAfterDiscount}
                    </dd>
                  </div>
                  ...
                  <div className="flex items-center justify-between border-y border-dashed py-4 ">
                    ...
                    <dd className="text-base font-medium text-gray-900"> ₹ {cart?.data?.totalAfterDiscount}</dd>
                  </div>
                </dl>
                <div className="px-2 pb-4 font-medium text-green-700">
                  You will save ₹   {cart?.data?.cartTotal-cart?.data?.totalAfterDiscount} on this order
                </div>
              </div>
            </section> */}
          </form>
